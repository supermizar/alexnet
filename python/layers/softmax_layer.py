...
class SoftmaxLayer(FcLayer):
    ...
    def __init__(self, network, node_count, momentum_rate=0.0, decay_rate=0.0):
        FcLayer.__init__(self, network, node_count, Softmax(), momentum_rate=momentum_rate, decay_rate=decay_rate)
